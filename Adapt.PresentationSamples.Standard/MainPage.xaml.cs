...
namespace Adapt.PresentationSamples
{
	...
	public partial class MainPage
	{
		...
		{
			FileDisplay.Source = ImageSource.FromFile(App.FileSource.GetFileString("kitten.jpg", FileSourceType.Image));
		}
		...
		{
			App.Clipboard.SetClipboardText("Here is some copied text");
		}
		...
		private void Red_Clicked(object sender, EventArgs e) => ContextualSquare.BackgroundColor = Color.Red;
		private void Blue_Clicked(object sender, EventArgs e) => ContextualSquare.BackgroundColor = Color.Blue;
		private void Green_Clicked(object sender, EventArgs e) => ContextualSquare.BackgroundColor = Color.Green;
	}
}