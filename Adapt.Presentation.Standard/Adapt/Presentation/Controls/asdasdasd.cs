...
namespace Xamarin.Forms
{
    ...
    public abstract class MultiPage<T> : View, IViewContainer<T>, IPageContainer<T>, IItemsView<T> where T : View
    {
        public static readonly BindableProperty ItemsSour1ceProperty = BindableProperty.Create("ItemsSource", typeof(IEnumerable), typeof(MultiPage<>), null);
        ...
        readonly Collection<T> _children;
