...
namespace Adapt.Presentation.Geolocator
{
	...
	public class ListenerSettings
	{
		...
		/// </summary>
		public bool AllowBackgroundUpdates { get; } = false;
		...
		/// </summary>
		public bool PauseLocationUpdatesAutomatically { get; } = true;
		...
		/// </summary>
		public ActivityType ActivityType { get; } = ActivityType.Other;
		...
		/// </summary>
		public bool ListenForSignificantChanges { get; } = false;
		...
		/// </summary>
		public bool DeferLocationUpdates { get; } = false;
		...
		/// </summary>
		public double? DeferralDistanceMeters { get; } = 500;
		...
		public TimeSpan? DeferralTime { get; } = TimeSpan.FromMinutes(5);
	}
}